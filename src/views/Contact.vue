...
const contactSupplierForm = ref<ContactSupplierForm>({
  companyName: '',
  contactPersonName: '',
  phoneNumber: '',
  email: '',
  typeOfSuppliedMaterials: '',
  yearsOfExperience: 0,
  companyBrief: '',
  additionalNotes: '',
  attachments: [],
})
const contactSubcontractorForm = ref<ContactSubcontractorForm>({
  companyName: '',
  contactPersonName: '',
  phoneNumber: '',
  email: '',
...
const contactCareerForm = ref<ContactCareerForm>({
  fullName: '',
  coverLetter: '',
  phoneNumber: '',
  email: '',
...
const contactInvestmentForm = ref<ContactInvestmentForm>({
  fullName: '',
  email: '',
  phoneNumber: '',
  companyName: null,
...
<template>
        ...
        <div class="col-12">
          <div class="sec-heading text-center">
            <span class="sub-title wow fadeInUp" data-wow-delay=".1s">
              <img src="/images/logos/small-logo.png" alt="small logo" />Contact info
            </span>
      ...
      <div class="row row-gap-4">
        <div class="col-sm-6">
          <div class="contact-item style-2 wow fadeInUp" data-wow-delay=".5s">
            ...
            <ul class="contact-list">
              <li
                v-for="contact in globalData?.contacts.filter((x) => x.type === 'Email')"
                :key="contact.title"
              >
                <b v-if="contact.title">{{ contact.title }}:</b
        ...
        <div class="col-sm-6">
          <div class="contact-item style-2 wow fadeInUp" data-wow-delay=".7s">
            ...
            <ul class="contact-list">
              <li
                v-for="contact in globalData?.contacts.filter((x) => x.type === 'Phone')"
                :key="contact.title"
              >
                <b v-if="contact.title">{{ contact.title }}:</b
  ...
  <section class="tj-contact-section-2 section-bottom-gap">
    <div class="container">
      <div class="row">
        <div class="col-12">
          selectedTab: {{ selectedTab === 'Subcontractors' }}
          <!-- Form Tabs Navigation -->
          <div class="form-tabs-wrapper wow fadeInUp" data-wow-delay=".1s">
            <div class="form-tabs">
              <button
                @click="selectedTab = tab"
                v-for="tab in contactFormTabs"
                :key="tab"
                :class="`form-tab-btn` + (selectedTab === tab ? ' active' : '')"
                :data-form="tab"
              >
                <span>{{ tab }}</span>
              </button>
          ...
          <!-- Suppliers Form -->
          <div
            :class="`contact-form form-panel ${selectedTab === 'Suppliers' ? 'active' : ''}`"
            id="TabSuppliers"
            data-wow-delay=".2s"
            v-if="selectedTab === 'Suppliers'"
          >
            <h3 class="title">Become a Supplier</h3>
            <p class="form-description">
              Partner with us to supply materials and services for our projects.
            </p>
            <form id="supplier-contact-form" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactSupplierForm.companyName" required />
                    <label class="cf-label">Company Name <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactSupplierForm.contactPersonName" required />
                    <label class="cf-label">Contact Person Name <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="tel" v-model="contactSupplierForm.phoneNumber" required />
                    <label class="cf-label">Phone Number <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="email" v-model="contactSupplierForm.email" required />
                ...
                <div class="col-sm-6">
                  <div class="form-input">
                    <input
                      ...
                      type="number"
                      v-model="contactSupplierForm.yearsOfExperience"
                      min="0"
                      required
                    />
                    <!-- <label class="cf-label">Years of Experience <span>*</span></label> -->
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea v-model="contactSupplierForm.companyBrief" required></textarea>
                    <label class="cf-label">Company Brief / Description <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="file-upload-wrapper">
                    <label class="file-upload-label">
                      ...
                      <span>Upload Documents (Company Profile, Catalogues, Certifications)</span>
                      <input
                        type="file"
                        multiple
                ...
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea v-model="contactSupplierForm.additionalNotes"></textarea>
          ...
          <!-- Subcontractors Form -->
          <div
            :class="`contact-form form-panel ${selectedTab === 'Subcontractors' ? 'active' : ''}`"
            id="subcontractors-form"
            v-if="selectedTab === 'Subcontractors'"
          >
            <h3 class="title">Become a Subcontractor</h3>
            <p class="form-description">
              Join our network of trusted subcontractors for construction projects.
            </p>
            <form id="subcontractor-contact-form" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactSubcontractorForm.companyName" required />
                    <label class="cf-label">Company Name <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input
                      type="text"
                      v-model="contactSubcontractorForm.contactPersonName"
                      required
                    />
                    <label class="cf-label">Contact Person Name <span>*</span></label>
                  </div>
                ...
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="tel" v-model="contactSubcontractorForm.phoneNumber" required />
                    <label class="cf-label">Phone Number <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="email" v-model="contactSubcontractorForm.email" required />
                    <label class="cf-label">Email Address <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <div class="tj-nice-select-box">
                      <div class="tj-select">
                        <select v-model="contactSubcontractorForm.typeOfWork" required>
                ...
                <div class="col-sm-3">
                  <div class="form-input">
                    <input
                      ...
                      placeholder="Years of Experience *"
                      type="number"
                      v-model="contactSubcontractorForm.yearsOfExperience"
                      name="experience"
                      required
                    />
                    <!-- <label class="cf-label">Years of Experience <span>*</span></label> -->
                ...
                <div class="col-sm-3">
                  <div class="form-input">
                    <input
                      ...
                      type="number"
                      v-model="contactSubcontractorForm.numberOfStaff"
                      name="workforce"
                      min="1"
                      required
                    />
                    <!-- <label class="cf-label">Number of Staff <span>*</span></label> -->
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea
                      ...
                      v-model="contactSubcontractorForm.previousProjects"
                      required
                    ></textarea>
                    <label class="cf-label">Previous Projects / References <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="file-upload-wrapper">
                    <label class="file-upload-label">
                      ...
                      <span>Upload Documents (Company Profile, Previous Work, Certificates)</span>
                      <input
                        type="file"
                        multiple
                        accept=".pdf,.doc,.docx,.jpg,.png"
                ...
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea
                      name="notes"
                      v-model="contactSubcontractorForm.additionalNotes"
                    ></textarea>
                    <label class="cf-label">Additional Notes (optional)</label>
                  </div>
                </div>
          ...
          <!-- Careers Form -->
          <div
            :class="`contact-form form-panel ${selectedTab === 'Careers' ? 'active' : ''}`"
            id="careers-form"
            v-if="selectedTab === 'Careers'"
          >
            <h3 class="title">Join Our Team</h3>
            <p class="form-description">
              Apply for exciting career opportunities with Al-Bina Al-Markazy.
            </p>
            <form id="careers-contact-form" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactCareerForm.fullName" required />
                    <label class="cf-label">Full Name <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="tel" v-model="contactCareerForm.phoneNumber" required />
                    <label class="cf-label">Phone Number <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="email" v-model="contactCareerForm.email" required />
                    <label class="cf-label">Email Address <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactCareerForm.positionAppliedFor" required />
                    <label class="cf-label">Position Applied For <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactCareerForm.specialization" required />
                    <label class="cf-label">Specialization / Field <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input
                      ...
                      placeholder="Years of Experience *"
                      type="number"
                      v-model="contactCareerForm.yearsOfExperience"
                      min="0"
                      required
                    />
                    <!-- <label class="cf-label">Years of Experience <span>*</span></label> -->
                ...
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea v-model="contactCareerForm.coverLetter"></textarea>
                    <label class="cf-label">Cover Message (optional)</label>
                  </div>
                </div>
                <div class="submit-btn">
                  <button
          ...
          <!-- Invest With Us Form -->
          <div
            :class="`contact-form form-panel ${selectedTab === 'Investment' ? 'active' : ''}`"
            id="invest-form"
            v-if="selectedTab === 'Investment'"
          >
            <h3 class="title">Investment Opportunities</h3>
            <p class="form-description">
              Explore investment partnership opportunities with Al-Bina Al-Markazy.
            </p>
            <form id="invest-contact-form" enctype="multipart/form-data">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactInvestmentForm.fullName" required />
                    <label class="cf-label">Full Name <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactInvestmentForm.companyName" />
                    <label class="cf-label">Company Name (if applicable)</label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="tel" v-model="contactInvestmentForm.phoneNumber" required />
                    <label class="cf-label">Phone Number <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="email" v-model="contactInvestmentForm.email" required />
                    <label class="cf-label">Email Address <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactInvestmentForm.typeOfInvestment" required />
                    <label class="cf-label">Type of Investment Interest <span>*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-input">
                    <input type="text" v-model="contactInvestmentForm.investmentAmount" />
                    <label class="cf-label">Estimated Investment Value (optional)</label>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea v-model="contactInvestmentForm.businessProposal" required></textarea>
                    <label class="cf-label"
                      >Brief Description of Investment Proposal <span>*</span></label
                    >
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="file-upload-wrapper">
                    <label class="file-upload-label">
                      ...
                      <span>Upload Proposal / Supporting Documents</span>
                      <input
                        type="file"
                        multiple
                        accept=".pdf,.doc,.docx,.jpg,.png"
                ...
                <div class="col-sm-12">
                  <div class="form-input message-input">
                    <textarea v-model="contactInvestmentForm.additionalNotes"></textarea>
                    <label class="cf-label">Additional Notes (optional)</label>
                  </div>
                </div>
                <div class="submit-btn">
  ...
  <div class="tj-contact-area section-gap">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="sec-heading text-center">
            <h2 class="sec-title title-anim"><span>Our</span> Branches</h2>
          </div>
        </div>
      </div>
      <div class="row row-gap-4">
        <div class="content">
          ...
          <div class="info-panel empty" id="infoPanel">
            <p>Click on a highlighted city to view branch details</p>
          </div>
        </div>
      </div>
    </div>
...
#iraq-map path.has-branch {
  fill: #01445e;
}

#iraq-map path.has-branch:hover {
  fill: #22708e;
}

#iraq-map path.active {
  fill: #48bb78;
  stroke: #2f855a;
  stroke-width: 2;
}
...
.branch-details h2 {
  ...
  margin-bottom: 20px;
  padding-bottom: 10px;
  border-bottom: 3px solid #01445e;
}
